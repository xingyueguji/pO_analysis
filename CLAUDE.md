...
the pre-2026-08-17 48 free `qcd_norm_<channel>` rateParams. **`lumi` lnN 1.03
...
- `test/my_script/make_pO_simfit_cards.sh` — simfit 50-channel datacards +
  ...
  plus the `qcd_lnn_kappas.txt` sidecar.
