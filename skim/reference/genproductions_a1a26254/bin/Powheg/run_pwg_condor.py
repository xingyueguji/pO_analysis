...
def runGetSource(parstage, xgrid, folderName, powInputName, process, noPdfCheck, tagName, svnRev, ion) :
    ...
    if ion == "Pb":
        ...
        template_dict["defaultPDF"] = 902750
        template_dict["period"] = "Run3_O"
    elif "EPPS21" in ion:
        template_dict["defaultPDF"] = 14600
        template_dict["period"] = "Run3_"+ion
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ion'    , dest="ion",    default= '',           help='Ion type. Options: Pb,O []')
    parser.add_argument('--prepareonly'    , dest="prepareonly",    default= 'none',           help='Create the scripts without running them')
    ...
    elif args.ion and args.ion not in ['Pb','O'] and "EPPS21_" not in args.ion:
       ...
       args.parstage == '01239' or args.parstage == 'f' : # full single grid in oneshot
        ...
        if os.path.exists(args.folderName+'/powheg.input') :
            ...
            if args.ion == "Pb":
                ...
                default_pdf = "902750" # EPPS21nlo_CT18Anlo_O16
            elif "EPPS21" in args.ion:
                default_pdf = "14600"
...
#                print "PDF in card: ", test_pdf1, "PDF default: ", default_pdf, test_pdf1==default_pdf
                ...
                if args.ion == "Pb":
                     ...
                     message = "The input card does not have the standard nuclear PDF (EPPS21nlo_CT18Anlo_O16, 902750): {0}. Either change the card or run again with -d 1 to   ignore this message.\n".format(test_pdf1)
