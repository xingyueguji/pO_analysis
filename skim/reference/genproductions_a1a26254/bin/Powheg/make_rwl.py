...
### sets for Run3 Heavy Ions
    ...
    if int(is5FlavorScheme) == 1:
        print("Going to use Run 3 5FS O nuclear PDFs")
        # 5F (n)PDF
        pdf_sets = {
            # weight id, LHAPDF id, name, replicas to be written
            "PDF_variation1 , hessian" :
            [
                ...
                [4503, 14670, 'CT18ANLO_as_0120', 1],
                # O16 nuclear PDFs
                [9000, 902750, 'EPPS21nlo_CT18Anlo_O16', 107],
                [9200, 3210700, 'TUJU21_nlo_16_8', 59],
                [9300, 3215700, 'TUJU21_nnlo_16_8', 59],
            ],
            "PDF_variation2 , replica" :
            [
                # Proton PDFs
                ...
                [3400, 332100, 'NNPDF40_nnlo_pch_as_01180', 1],
                # O16 nuclear PDFs
                [9400, 30022100, 'nNNPDF30_nlo_as_0118_A16_Z8', 201],
            ],
        }
    else:
        raise Exception("ERROR[make_rwl.py]: There are no 4FS nuclear PDFs!")
### sets for Run3 Heavy Ions
elif "EPPS21" in Period:
    if int(is5FlavorScheme) == 1:
        print("Going to use Run 3 5FS proton PDFs for EPPS21 nPDF")
        # 5F (n)PDF
        pdf_sets = {
            # weight id, LHAPDF id, name, replicas to be written
            "PDF_variation1 , hessian" :
